function ComicForm({image, setsImage, title, setsTitle, issue, setsIssue, description, setsDescription}) {
  ...
  function handleSubmit(e){
    e.preventDefault()
    console.assert(image != '', 'testing image value input', image)
    e.target.reset()
  }
  ...
  return (
    ...
    <form className="comic-form" onSubmit={(e)=>handleSubmit(e)}>
      ...
      <input name="image_url" value='' onChange={(e)=>setsImage(e.target.value)}/>

      <label htmlFor="title">Title: </label>
      <input name="title" value='' onChange={(e)=>setsTitle(e.target.value)}/>
      {console.log(title)}

      <label htmlFor="issue">Issue Number: </label>
      <input name="issue" type="number" value='' onChange={(e)=>setsIssue(e.target.value)}/>

      <label htmlFor="description">Description: </label>
      <input name="description"  value='' onChange={(e)=>setsDescription(e.target.value)}/>
